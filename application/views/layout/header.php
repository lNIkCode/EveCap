...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url();?>assets/dist/css/skins/_all-skins.min.css">
  <?php } ?>
  <!--FIN CONTROLADOR CREPORTES -->
  <!--INICIO CONTROLADOR regpersonas -->
...
<?php } ?>
<!--FIN CONTROLADOR regpersonas -->
<!--INICIO CONTROLADOR EVENTOS -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Sistema</b>EveCap</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Bienvenido a EveCap</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!--<li class="user-body">
            ...
            <!--  </li> -->
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url();?>clogin/logout" class="btn btn-default btn-flat">Cerrar Sesion</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <?php
  if(!$this->session->userdata('s_codusu')){
    redirect('clogin');
  }
   ?>
